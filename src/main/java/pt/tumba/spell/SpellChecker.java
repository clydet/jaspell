...
//    }
    ...
    if (!heuristics || aux.size() == 0) {
      for (i = 0; i < size - 1; i++) {
        ...
        Object frequency = dictionary.get(auxs);
        if (frequency != null)
          aux.add(0, auxs);
...
//    }
  ...
  public static void main(String args[]) throws Exception {
    try {
      ...
      //spellCheck.initialize("dict/english.txt");
      spellCheck.initialize("/Users/clydetedrick/Documents/drcots/jaspell/src/main/resources/dict/english.txt");
          //, "/Users/clydetedrick/Documents/drcots/jaspell/src/main/resources/dict/common-misspells.txt");
      ...
      while (true) {
        ...
        while ((aux = finder.next())!=null) {
          ...
          List suggestions = spellCheck.findMostSimilarList(aux, false);
          if (aux2 == null) {
